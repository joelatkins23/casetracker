...
import Editrequest from './editcontent';
...
class Request extends Component {
    ...
    render(){
      ...
      <Container>  
          ...
          <Row>
            <Col>
              <h1 className="con-title">MedicalRequestList</h1>
            </Col>
          </Row>
          <Row>
            <Col>
            <Link to="/MedicalRequestList/add" className="add-btn">Add More</Link>
            </Col>
          </Row>
            
            <Switch>
                        <Route  path="/MedicalRequestList/add">
                          <Addrequest />
                          
                        </Route>
                        <Route  path="/MedicalRequestList/edit">
                          <Editrequest
            ...
            <Table  responsive striped bordered hover className="mt-2">
              ...
              <tbody>
              {
                this.state.hello[0].Employeeid=='hello'
                ? (<h1></h1>):(
            ...
            <Modal show={this.state.show} onHide={this.handleClose}>
                    ...
                    <Modal.Footer>
                      ...
                      <Link to="MedicalRequestList/edit" className="register">Edit</Link>
                      </Button>
